    ...
    mkpLeftControls = () => {
        ...
        return (
            <div className="mkp-left-controls">
                ...
                {/* play btn */}
                <button className="mkp-play-button mkp-button" title="play" onClick={video && video.playOrPauseVide}>
                    <img src={isPlay ? "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACQAAAAkCAYAAADhAJiYAAAAg0lEQVRYR+2XwQrAIAxDzZ/vzzt2GMhwxDIPnTyPttaYRKlqxYaK4WkAcorA0J4MRcQxOpmk4Xw2v6895aGIiBdAw/XZfADdDEiyitiEq1hWgmw+kiHZ80nAQ84TMARDX28NHsJDeKhj4Lf9UK0m3/2lVsanJFu5oasFIBhyDLh4OQ+d9xSwJVowjfEAAAAASUVORK5CYII=" : "data:image/png;base64,"} alt="play" />
                </button>
                {/* next video */}
                ...
                <span className="mkp-volume">
                    <button ref="volume" className="mkp-mute-button mkp-button" title="m" onClick={this.handleVolumeOnOrOff} aria-label={curVolume === 0 ? "off" : "on"}>
                        <img
                            src={curVolume === 0 ?
